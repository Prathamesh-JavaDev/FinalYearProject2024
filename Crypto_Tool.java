...
class AppDesk extends JFrame implements ActionListener,ItemListener{
	...
	public AppDesk() {
		...
		File a = new File("C:/Crypto-Tool-2.0/algo");
	...
	public void itemStateChanged(ItemEvent e){
		...
		switch(clr){
			case "CaesarCypher":{
				FileInputStream cc = new FileInputStream("C:/Crypto-Tool-2.0/algo/CaesarCypher.txt");
			...
			case "ModifiedCaesarCypher":{
				FileInputStream mcc = new FileInputStream("C:/Crypto-Tool-2.0/algo/ModifiedCaesarCypher.txt");		
			...
			case "VigenereCypher":{
				FileInputStream vc = new FileInputStream("C:/Crypto-Tool-2.0/algo/VigenereCypher.txt");		
