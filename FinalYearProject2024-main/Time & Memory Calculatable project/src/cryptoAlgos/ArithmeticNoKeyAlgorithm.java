...
public class ArithmeticNoKeyAlgorithm implements CryptoAlgorithm {
    ...
    public String encrypt(String plaintext) {
        ...
        if (plaintext.isEmpty()) {
            ...
            System.out.println("(Arithmetic Algorithm) Encryption Time: " + elapsedTime + " milliseconds");

            long memoryRequired = measureMemoryUsage();
            System.out.println("(Arithmetic Algorithm) Encryption Memory Required: " + memoryRequired + " bytes");
    ...
    public String decrypt(String ciphertext) {
        ...
        if (ciphertext.isEmpty()) {
            ...
            long endTime = System.nanoTime();
            double elapsedTime = (endTime - startTime) / 1e6; // Convert to milliseconds
            System.out.println("(Arithmetic Algorithm) Decryption Time: " + elapsedTime + " milliseconds");

            long memoryRequired = measureMemoryUsage();
            System.out.println("(Arithmetic Algorithm) Decryption Memory Required: " + memoryRequired + " bytes");
